<template>
  <div id="app">
    ...
    <aside class="layout-sidebar">
      <div class="logo-area">
        <img src="/logo.png" alt="LitBanana" class="logo-icon" />
        <span class="logo-text">LitBanana</span>
      </div>
      ...
      <div style="margin-top: auto; padding-top: 20px; border-top: 1px solid var(--border-color);">
        <div style="display: flex; align-items: center; gap: 10px;">
          <img src="/logo.png" alt="小香蕉" style="width: 36px; height: 36px; border-radius: 50%; object-fit: cover;" />
          <div>
            <div style="font-size: 14px; font-weight: 600;">小香蕉</div>
            <div style="font-size: 12px; color: var(--text-sub);">LitBanana</div>
          </div>
        </div>
      </div>
    </aside>
        ...
        <footer v-if="route.path !== '/'" class="global-footer">
          <div class="footer-content">
            <div class="footer-text">
              © 2025 <a href="https://github.com/HisMax/LitBanana" target="_blank" rel="noopener noreferrer">LitBanana</a> by 小香蕉 (Histone)
            </div>
